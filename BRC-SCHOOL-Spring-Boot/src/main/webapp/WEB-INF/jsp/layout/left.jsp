	...
	<aside id="leftsidebar" class="sidebar">
		...
		<div class="user-info">
			...
			<div class="info-container">
				<div class="name" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"><sec:authentication property="name"/></div>
				<div class="email"><sec:authentication property="principal"/></div>
		...
		<div class="menu">
			<ul class="list">
				...
				<!-- START LEFT NAV FOR ADMIN -->
				<sec:authorize access="hasAuthority('ADMIN')">
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
							class="material-icons">group_add</i> <span>Manage User(s)</span>
					</a>
						<ul class="ml-menu">
							<li><a href="javascript:void(0);"> <span>User</span>
							</a></li>
							<li><a href="javascript:void(0);"> <span>User Mapping</span>
							</a></li>
						</ul></li>

				</sec:authorize>
				
				<!-- END LEFT NAV FOR ADMIN -->
				...
				<li><a href="javascript:void(0);" class="menu-toggle"> <i
					...
					<ul class="ml-menu">
						...
						<li><a href="pages/examples/500.html">500 - Server Error</a>
						</li>
					</ul></li>
				<li><a href="javascript:void(0);" class="menu-toggle"> <i
		...
		<div class="legal">
			<div class="copyright">
				&copy; 2020 - 2021 <a href="javascript:void(0);">Brc Group -
					Smart school tool</a>.
			</div>
			<div class="version">
				<b>Version: </b> beta
